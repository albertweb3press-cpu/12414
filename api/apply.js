/**
 * POST /api/apply - проксирование заявок на отдельный хост (Vercel)
 * Формат как на скрине "NEW JOB APPLICATION"
 * Совместим с текущим server.js, но шлёт на новый бот 8842189334
 */
